...
class Sale_report_model extends CI_Model {
	...
	/* sale_report function starts */   
	
	function get_all_filter_sales($params = array()){
		$whrs ='';  
	...
	function update_sale_data($args1,$data){ 
		$this->db->where('id',$args1);
		return $this->db->update('bookings_tbl', $data);
	} 
	
	/* operating sale_reports data starts */ 
