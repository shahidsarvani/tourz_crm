	...
	<div class="row">
	  ...
	  <?php 
		...
		if(isset($args1) && $args1>0){
			$form_act = "bookings/update/".$args1;
		} ?>
		<form name="datas_form" id="datas_form" method="post" action="<?php echo site_url($form_act); ?>" class="form-horizontal">
		  ...
		  <div class="form-group">
			...
			<div class="col-md-6">
			  <input name="booking_date" id="booking_date" type="text" class="form-control" value="<?php echo (isset($record)) ? stripslashes($record->booking_date): set_value('booking_date'); ?>" data-error="#booking_date1" readonly="ture">
		  ...
		  <div class="form-group">
			...
			<div class="col-md-6"> 
			  <select name="package_id" id="package_id" class="form-control cstm_select2" data-error="#package_id1" onChange="operate_bookings_status();">
				...
				<?php   
					$no_of_adults_per_price1 = $no_of_childs_per_price1 = '';
					...
					if(isset($package_arrs) && count($package_arrs)>0){ 
						foreach($package_arrs as $package_arr){
						   ...
						   if((isset($_POST['package_id']) && $_POST['package_id']==$package_arr->id) || (isset($record) && $record->package_id==$package_arr->id)){
						   		$no_of_adults_per_price1 = $package_arr->adult_ticket_price;
								$no_of_childs_per_price1 = $package_arr->child_ticket_price;
						   } ?>  
							 <option value="<?php echo $package_arr->id; ?>" <?php echo ((isset($_POST['package_id']) && $_POST['package_id']==$package_arr->id) || (isset($record) && $record->package_id==$package_arr->id)) ? 'selected="selected"':''; ?>> <?php echo $package_arr->name; ?> </option>  
					<?php 
						}
					} ?>  
				</select> 
		  ...
		  <div class="form-group">
			...
			<div class="col-md-6"> 
				<div class="input-group"> 
					...
					<?php  
						for($a=1; $a <=10; $a++){ ?>  
							<option value="<?php echo $a; ?>" <?php echo ((isset($_POST['no_of_adults']) && $_POST['no_of_adults']==$a) || (isset($record) && $record->no_of_adults==$a)) ? 'selected="selected"':''; ?>> <?php echo $a; ?> </option>  
						<?php  
						}  ?>  
					</select>  
					<span class="input-group-addon"><i class="icon-mentions" id="no_of_adults_per_price"> <?php echo $no_of_adults_per_price1; ?>  </i></span>
				</div>  
		   ...
		   <div class="form-group">
				...
				<div class="col-md-6"> 
					...
					<?php  
						for($a=1; $a <=10; $a++){ ?>  
							<option value="<?php echo $a; ?>" <?php echo ((isset($_POST['no_of_childs']) && $_POST['no_of_childs']==$a) || (isset($record) && $record->no_of_childs==$a)) ? 'selected="selected"':''; ?>> <?php echo $a; ?> </option>  
						<?php
						} ?>
					</select>
				<span class="input-group-addon"><i class="icon-mentions" id="no_of_childs_per_price"> <?php echo $no_of_childs_per_price1; ?> </i></span>
			</div>
		   ...
		   <div class="form-group">
			...
			<div class="col-md-6">
			  <input name="total_costs" id="total_costs" type="text" class="form-control" value="<?php echo (isset($record)) ? stripslashes($record->total_costs): set_value('total_costs'); ?>" data-error="#total_costs1">
			  ...
			  <div class="form-group">
				...
				<div class="col-md-6">
				  <input name="discounts" id="discounts" type="text" class="form-control" value="<?php echo (isset($record)) ? stripslashes($record->discounts): set_value('discounts'); ?>" data-error="#discounts1">
			  ...
			  <div class="form-group">
				...
				<div class="col-md-6">
				  <input name="vats" id="vats" type="text" class="form-control" value="<?php echo (isset($record)) ? stripslashes($record->vats): set_value('vats'); ?>" data-error="#vats1">
			  ...
			  <div class="form-group">
				...
				<div class="col-md-6">
				<textarea name="message" id="message" style="width:100%;" rows="5" class="form-control" data-error="#message1"><?php echo (isset($record)) ? stripslashes($record->message): set_value('message'); ?></textarea> 
			   ...
			   <div class="form-group">
				...
				<div class="col-md-6"> 
				 <select name="cash_type" id="cash_type" class="form-control cstm_select2" data-error="#cash_type1">
					...
					<option value="1" <?php echo ((isset($_POST['cash_type']) && $_POST['cash_type']==1) || (isset($record) && $record->cash_type==1)) ? 'selected="selected"':''; ?>> Cash on pickup </option>
					<option value="2" <?php echo ((isset($_POST['cash_type']) && $_POST['cash_type']==2) || (isset($record) && $record->cash_type==2)) ? 'selected="selected"':''; ?>> Cash via Bank </option> 
				</select>    
				  <span id="cash_type1" class="text-danger"><?php echo form_error('cash_type'); ?></span> </div>
				   ...
				   <div class="form-group">
					...
					<select name="status" id="status" class="form-control cstm_select2" data-error="#status1">
						...
						<option value="1" <?php echo ((isset($_POST['status']) && $_POST['status']==1) || (isset($record) && $record->status==1)) ? 'selected="selected"':''; ?>> Confirm </option>
						<option value="2" <?php echo ((isset($_POST['status']) && $_POST['status']==2) || (isset($record) && $record->status==2)) ? 'selected="selected"':''; ?>> Delete  </option>
						<option value="3" <?php echo ((isset($_POST['status']) && $_POST['status']==3) || (isset($record) && $record->status==3)) ? 'selected="selected"':''; ?>> Reject </option> 
						<option value="4" <?php echo ((isset($_POST['status']) && $_POST['status']==4) || (isset($record) && $record->status==4)) ? 'selected="selected"':''; ?>> No Show </option> 
					</select>   
