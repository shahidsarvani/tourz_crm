...
<div class="page-container"> 
  ...
  <div class="page-content"> 
    ...
    <div class="content-wrapper"> 
        ...
        <script>
        	function operate_sale_report_list(){  	  
				$(document).ready(function(){ 
					...
					$.ajax({ 
						method: "POST",
						url: "<?php echo site_url('/sale_report/index2/'); ?>",
			...
			function view_sale_detail(paras1){  
				if(paras1>0){			
					$(document).ready(function(){    
					<?php
						$booking_dtl_popup_url = 'sale_report/sale_detail/';
						...
						$('#modal_remote_sale_detail').modal({show: false})
	  ...
	  <div id="modal_remote_sale_detail" class="modal fade" data-backdrop="false"> 
        ...
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <ul class="icons-list">
                    ...
                    <li><a data-action="reload" onClick="window.location='<?php echo site_url('sale_report/index'); ?>'"></a></li>
     	...
     	<div class="row">
            <div class="col-md-12"> 
            	...
            	<div class="form-group mb-md">   
				  ...
				  <select name="per_page" id="per_page" class="form-control input-sm mb-md cstm_select2" onChange="operate_sale_report_list();">
				   ...
				   <div class="col-md-3">  
				   <select name="package_id" id="package_id" class="form-control cstm_select2" data-error="#package_id1" onChange="operate_sale_report_list();">
                  ...
                  <div class="col-md-3">  
                  <input name="from_date" id="from_date" onKeyUp="operate_sale_report_list();" placeholder="From Date..." type="text" class="form-control input-sm mb-md" readonly="true" style="text-align:center;">   
            	  </div> 
				  
				  
                  <div class="col-md-3">  
                  <input name="to_date" id="to_date" onKeyUp="operate_sale_report_list();" placeholder="To Date..." type="text" class="form-control input-sm mb-md" readonly="true" style="text-align:center;">   
            	  </div>   
            ...
            <table class="table table-bordered table-striped table-hover">
              <thead>
               	<tr>
                    ...
                    <th width="16%">Package</th>
                    <th width="16%" class="text-center">Total income</th>
                    ...
                    if(isset($records) && count($records)>0){
                        foreach($records as $record){  ?>
						  <tr class="<?php echo ($sr%2==0)?'gradeX':'gradeC'; ?>">
							<td> <?php echo $sr; ?> </td> 	
							<td> <a href="javascript:void(0);" onClick="return view_sale_detail('<?php echo $record->id; ?>');" data-toggle="modal" data-target="#modal_remote_sale_detail"><?php echo ($record->is_new==1) ? ' <span class="status-mark bg-danger"> &nbsp; </span>':''; /* && $vs_id==$record->assigned_to_id*/ ?>  #<?= $record->id.' - '.stripslashes($record->name); ?></a> </td>
							<td><?php 
							...
							<?php   
								...
								echo ($total_income>0) ? number_format($total_income, 2) : '0'; ?>						
							</td>
                       ...
                       <tr>
                       <td colspan="5">
                       <div style="float:left;">  <select name="per_page" id="per_page" class="form-control input-sm mb-md cstm_select2" onChange="operate_sale_report_list();">
                          <option value="25"> Pages</option>
                          <option value="25"> 25 </option>
                          <option value="50"> 50 </option>
                          <option value="100"> 100 </option> 
